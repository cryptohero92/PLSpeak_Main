...
export default function LineCharts({ data = [], dataKeys = [], filters = [], showLegend = true, yTickFormatter = (e) => e }) {
    return (
        <div className="line-chart-wrapper" style={{ float: 'left', width: '100%', height: '350px' }}>
